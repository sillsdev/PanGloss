...
`integrate-conformance-framework`, at `conformance/edge-cases/final-template-partial-discriminators/`.
...
Machine issue: https://github.com/sillsdev/machine/issues/507
