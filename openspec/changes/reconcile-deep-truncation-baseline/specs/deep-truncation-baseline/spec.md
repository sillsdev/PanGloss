...
### Requirement: Deep-truncation-chain evidence uses an honest pinned baseline
Correctness and performance evidence for the deep-truncation-chain-shaped synthetic grammar SHALL name the grammar hash, code commit, rule-support manifest, denominator, and exact analysis manifest.
...
The deep-truncation-chain gate and trace harness SHALL use one shared constructor and SHALL report the same network fingerprint.
