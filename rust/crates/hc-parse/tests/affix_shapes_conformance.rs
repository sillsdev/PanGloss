...
//! `crates/hc-parse/tests/discontinuous_env_gate.rs`). Each fixture's README documents the
...
//! signature. Fixed in wave-4 (`hc_rules::morph::attribute_morphs`'s tail-ordered fallback record,
