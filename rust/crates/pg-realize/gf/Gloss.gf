...
--
-- Typed-construction shape mirrors rust/crates/hc-realize/src/ir.rs's GlossIr exactly, one
...
-- abstract category literally named Num (rust/crates/hc-realize/gf research, verified against
...
abstract Gloss = {
  ...
  fun
    ...
    -- (rust/crates/hc-realize/src/table.rs's cell key). 4 Case x 9 Poss x 3 GNum = 108
