...
-- full explanation and GlossFunctor.gf's header for the "Syntax"/"SyntaxEng" naming correction
-- this file's `with (...)` clause reflects). NOT yet compile-verified -- there is no `gf` install
