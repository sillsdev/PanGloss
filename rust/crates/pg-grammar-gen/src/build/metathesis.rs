//! `MetathesisRuleDef` HONEST-SKIP bail gate builder (synthetic-stress-grammar-plan.md §2 row
//! `MetathesisRuleDef`; design doc §6 priority (7), pure test-writing -- `pg_foma::replace::
