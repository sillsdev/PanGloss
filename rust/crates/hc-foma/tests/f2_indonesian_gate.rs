...
//! junction-aware emitter (`hc_foma::emit` + `hc_foma::junctions::PhonologyProbe`) against the real
...
//! junction — `meN+tulis -> menulis`), with the FULL ENGINE (`hc_parse::Morpher`, a dev-dependency
