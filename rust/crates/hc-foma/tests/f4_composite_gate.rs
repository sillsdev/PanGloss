...
//! (`hc_foma::composite::FomaAnalyzer`) against the real Sena and Indonesian grammars, with the FULL
//! ENGINE (`hc_parse::Morpher::parse_word_opts`, now a normal — not dev-only — dependency as of P2)
