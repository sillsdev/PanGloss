...
//! exact structural juncture the real corpus never hits (see `hc-foma/src/gate.rs`'s module doc),
//! then prints what the REAL oracle (`hc_parse::Morpher`) says for 4 query words -- gathered
...
use hc_foma::gate::compile_gated_grammar;
use hc_foma::replace::SegAlphabet;
use hc_foma::tags;
use hc_grammar::chardef::CharDefKind;
use hc_grammar::model::PhonRuleDef;
...
fn load_indonesian_augmented() -> hc_grammar::model::Grammar {
