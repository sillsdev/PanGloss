...
//! `MorphemeId` is already a dense index into `Grammar::morphemes` (`hc-grammar/src/model.rs:60`).
//!
...
use hc_grammar::model::MorphemeId;
...
/// this is a fresh definition so `hc-foma` never depends on it.
