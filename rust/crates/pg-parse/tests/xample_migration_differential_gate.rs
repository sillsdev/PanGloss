...
// Ignored because the witness is a FieldWorks project plus a built projector, neither of which CI has.
#[ignore = "needs the FieldWorks/XAMPLE witness: set PANGLOSS_MACHINE_DIR at a checkout that has it"]
#[test]
