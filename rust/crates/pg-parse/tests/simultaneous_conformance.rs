...
/// (`Morpher::with_memo`/`pg-memo`, rust-optimizations-phase2.md Phases 2/9/10) — the design doc
...
/// `ana_epenthesis` in both `analyze` and `analyze_cached` (`pg-rules/src/rewrite.rs`) runs its body
