...
//!
//! This is the only crate `pg-ffi` and `pg-cli` call; everything below it is engine-internal
...
pub struct WordAnalysis {
    ...
    /// per-analysis too since the wire format shouldn't bake in that coupling (`pg-ffi`'s eventual
