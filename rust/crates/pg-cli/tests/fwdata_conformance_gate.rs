...
//! `cargo test -p pg-cli --release --ignored`.
//!
...
#[ignore] // expensive: full 7,121-word Sena corpus through two uncapped Grammars; run with
          // `cargo test -p pg-cli --release --ignored sena3_new_pipeline_matches_legacy_oracle`
...
#[ignore] // expensive: full 673-word Amharic corpus through two uncapped Grammars; run with
          // `cargo test -p pg-cli --release --ignored amharic_new_pipeline_matches_legacy_oracle`
