use pg_foma_backend::health::{FindingCode, Phase, Severity};
use pg_foma_backend::health_evaluator::{evaluate, AttemptedPhases, CompileMeasurements};
...
fn an_oversized_payload_is_labelled_not_production_ready() {
    let oversized = pg_foma_backend::health::IDEAL_MAX_BYTES + 1;
