...
/// PARITY: a duplicate, not a reuse, of `hc_parse::surface::matching_reps_for_node`'s Segment
/// branch (`hc-parse/src/surface.rs`); hc-parse depends on hc-rules, so the reverse dependency this
