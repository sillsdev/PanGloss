...
//! branch `hc_rules::validity::allomorphs_valid_impl` added for a guessed (fabricated) root.
//!
...
use hc_rules::validity::allomorphs_valid;
use hc_rules::word::{GuessedRoot, MorphRecord};
use hc_rules::Word;
...
fn shape_of(g: &Grammar, text: &str) -> hc_shape::Shape {
...
fn guessed_word(g: &Grammar, text: &str) -> Word {
    ...
    let mut w = Word::new(shape_of(g, text), hc_grammar::model::StratumId(0));
...
fn pers_p1_fs(g: &Grammar) -> hc_featstruct::FeatureStruct {
