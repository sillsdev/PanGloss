...
//!
//! Both hand-built tests below follow `morph_gate.rs`'s pattern (real `hc_grammar::load`-ed probe
//! grammar, hand-authored `MorphRuleDef`s, `hc_rules::morph::{synthesize, analyze}` as the only
