//! One-off measurement (`pg.ps1 -Mode run -Example lab -- adjudicate_templated_backend`): raw templated-network acceptance vs. post-confirm result, per fixture.
...
use pg_foma_backend::backend_optimizer::Certification;
...
fn run_fixture(
    ...
    let observed = pg_foma_backend::backend_runtime::evaluate_plans_observed_with_cache(
        &grammar,
        &[candidate],
        &words,
