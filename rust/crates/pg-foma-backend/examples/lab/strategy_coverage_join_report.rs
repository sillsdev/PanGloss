//! Deliverable 1: `strategy_coverage` table x measurement JOIN report (`pg.ps1 -Mode run -Example lab -- strategy_coverage_join_report`); see `pg_foma::strategy_coverage_join` for the sound/unsound direction split this classifies by.
...
use pg_foma_backend::strategy_coverage_join::{
