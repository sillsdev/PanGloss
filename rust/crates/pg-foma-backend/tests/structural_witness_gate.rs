...
use pg_foma_backend::conformance_coverage::registered_structural_witnesses;
...
fn the_hand_identified_witness_fixture_for_each_construct_still_qualifies() {
    let expectations = [
        WitnessExpectation {
            ...
            predicate: pg_foma_backend::conformance_coverage::grammar_has_unordered_stratum,
        ...
        WitnessExpectation {
            ...
            predicate: pg_foma_backend::conformance_coverage::grammar_has_empty_lhs_rewrite_rule,
        ...
        WitnessExpectation {
            ...
            predicate:
                pg_foma_backend::conformance_coverage::grammar_has_circumfix_shaped_allomorph,
