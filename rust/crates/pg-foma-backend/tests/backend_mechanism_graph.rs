...
use pg_foma_backend::backend_mechanism::{
...
#[test]
fn backend_mechanism_wire_ids_round_trip_every_native_domain() {
...
#[test]
fn backend_mechanism_sources_convert_every_model_location_variant() {
    let cases = [
        (
...
#[test]
fn backend_mechanism_rejects_missing_producer() {
...
#[test]
fn backend_mechanism_rejects_a_node_with_no_typed_source() {
...
#[test]
fn backend_mechanism_rejects_self_edge() {
...
#[test]
fn backend_mechanism_rejects_symbol_space_and_table_mismatch() {
...
#[test]
fn backend_mechanism_rejects_wrong_and_out_of_range_wire_domains() {
...
#[test]
fn backend_mechanism_rejects_boundary_cleanup_before_another_consumer() {
    let err = graph(
        vec![
            morphotactics("morph"),
            cleanup("cleanup"),
...
#[test]
fn backend_mechanism_boundary_state_is_derived_not_declared() {
...
#[test]
fn backend_mechanism_rejects_disconnected_paths() {
    let err = graph(
        vec![
...
#[test]
fn backend_mechanism_rejects_duplicate_mechanism_id() {
    let err = graph(
...
#[test]
fn backend_mechanism_rejects_cycle() {
    let err = graph(
        vec![
            morphotactics("left"),
            morphotactics("right"),
...
#[test]
fn backend_mechanism_rejects_stratum_mismatch() {
...
#[test]
fn backend_mechanism_accepts_composable_morphotactics_cleanup_graph() {
    graph(
...
#[test]
fn backend_mechanism_binding_folds_a_known_gap_to_confirm_only() {
    let mut node = morphotactics("morph");
...
#[test]
fn backend_mechanism_routing_is_a_total_onto_partition_of_the_construct_set() {
