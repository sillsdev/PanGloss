...
use pg_foma_backend::backend_optimizer::{pareto_frontier, select_confirmed, Certification};
...
fn cached_and_uncached_scores_and_winner_are_invariant() {
    ...
    let winner = |evaluations: &[pg_foma_backend::backend_runtime::RuntimeEvaluation]| {
        evaluations
            .iter()
            .enumerate()
