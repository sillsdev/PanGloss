//! Full backend scoreboard (`pg.ps1 -Mode run -Example lab -- conf_matrix`): a printer over
...
pub fn main(_args: &[String]) {
    ...
    println!(
        "reproduce: rust/tools/pg.ps1 -Mode run -Example lab -- conf_matrix   (from the repo root \
         of the worktree this was measured in)"
    );
}
