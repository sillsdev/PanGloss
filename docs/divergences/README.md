...
| 046 | [Entry-local stem MSA deduplication](046-entry-local-unique-stem-msas.md) | behavioural | open | FieldWorks `HCLoader.UniqueStemMSAs` / liblcm `MoStemMsa.EqualsMsa` | `pg-grammar/src/compile/lexicon.rs` | `pg-grammar/src/compile/tests/unique_stem_msas.rs`, `compile/lexicon/unique_stem_tests.rs` |
