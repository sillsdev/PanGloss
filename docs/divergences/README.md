...
| 024 | [Analysis memo key saturates unapplication counts; C# does not](024-memo-key-count-saturation.md) | representational | superseded | `AnalysisStateKey.cs:14-34` | `pg-rules/src/stratum.rs::state_key` | `pg-rules/tests/memo_gate.rs::state_key_saturates_unapplication_counts_past_max_apps`, `pg-rules/tests/unapplied_rule_counts_reader_gate.rs` |
| 025 | [Two in-flight re-entrancy guards where C# has one](025-two-in-flight-guards.md) | representational | superseded | `AnalysisScope.cs:56-60` (`InProgress`) | `pg-memo/src/lib.rs` (`in_flight`, `template_in_progress`) | none — claimed correctness-neutral by construction |
...
| 031 | [Analysis cascade memoization](031-analysis-cascade-memo.md) | efficiency | superseded | `AnalysisStratumRule / AnalysisScope` | `pg-rules/src/stratum.rs::memo_apply_rules` | See entry: implementation, fixture and evidence status are separate |
| 032 | [Template-battery memoization](032-template-battery-memo.md) | efficiency | superseded | `AnalysisAffixTemplatesRule / AnalysisScope` | `pg-rules/src/stratum.rs::run_template_batch` | See entry: implementation, fixture and evidence status are separate |
